...
exports.run = async (client, message, args) => {
    try {
        ...
        const messageReqeust = await message.channel.createMessageCollector((m) => m.author.id === message.author.id, { time: 200000 });
        ...
        async function ytdl(datas) {
            ...
            const embedInfo = new Discord.MessageEmbed().setColor(client.warna.kato)
            ...
            const embedDl = new Discord.MessageEmbed().setColor(client.warna.kato).setTitle('Download Link');

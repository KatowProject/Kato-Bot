...
exports.run = async (client, message, args) => {
  ...
  if (!args[0]) {
    ...
    const embed = new MessageEmbed().setColor("#985ce7").setTimestamp().setFooter(`© 2020, Perkumpulan Orang Santai • Total: ${client.commands.size} commands`, client.user.avatarURL).setDescription(`Ketik \`k!help [command] / @mention help [command]\` untuk menambahkan informasi lebih lanjut mengenai sebuah perintah.`).setTitle('Kato-Bot Command List')

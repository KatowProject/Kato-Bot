...
exports.run = async (client, message, args) => {
    ...
    if (bannerUser) {
        ...
        embed.setDescription(`[Avatar URL](${mention.displayAvatarURL({ size: 4096, forceStatic: true })})`) //redirect to avatar link
        ...
        embed.setDescription(`[Avatar URL](${userID.user.displayAvatarURL({ size: 4096, forceStatic: true })})`)
        ...
        embed.setDescription(`[Avatar URL](${message.author.displayAvatarURL({ size: 4096, forceStatic: true })})`)
        ...
        embed.setDescription(`[Avatar URL Link](${message.guild.iconURL({ size: 4096, forceStatic: true })})`)
        ...
        embed.setDescription(`[Avatar URL](${find.user.displayAvatarURL({ size: 4096, forceStatic: true })})`)
